...
from items import CompItem, ContItem, CustomsItem, Customs_InfoItem, ProfitItem, CashItem, Decash_AllItem, DecashItem, Decash_EqItem, ImageItem
...
class XiaomanSpider(Spider):
    ...
    def start_requests(self):
        ...
        yield from [Request(url, callback=self.parse_, dont_filter=True) for url in urls]
